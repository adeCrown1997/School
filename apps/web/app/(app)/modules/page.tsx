...
const PLANNED_MODULES: ModuleInfo[] = [
  { name: 'Course Registration', description: 'Enrol in courses each semester.', audience: 'student' },
  ...
  { name: 'Course Management', description: 'Define courses, allocate lecturers.', audience: 'staff' },
...
export default function ModulesPage() {
  ...
  const modules = PLANNED_MODULES.filter(
    (m) => m.audience === 'all' || (isStudent ? m.audience === 'student' : m.audience === 'staff'),
  );
